...
import sdarty.larpo.blaol.databinding.ActivityMainBinding
...
class GameActivity : AppCompatActivity() {
    ...
    private  val frontCrystals by lazy {
        listOf(
            ...
            binding.itemHolder.i31front, binding.itemHolder.i32front, binding.itemHolder.i33front, binding.itemHolder.i34front, binding.itemHolder.i35front,
        )
    }
    private  val backCrystals by lazy {
        listOf(
            ...
            binding.itemHolder.i31back, binding.itemHolder.i32back, binding.itemHolder.i33back, binding.itemHolder.i34back, binding.itemHolder.i35back,
        )
    }
    ...
    private val pictyre = listOf(R.drawable.symbol_1, R.drawable.symbol_2, R.drawable.symbol_3 ,R.drawable.symbol_4,R.drawable.symbol_5,R.drawable.symbol_6,R.drawable.symbol_7)
    ...
    private fun startGame() {
        ...
        gameCoroutine = CoroutineScope(Dispatchers.Main).launch{
            ...
            for (i in 0..34 ){
                flipKartunka(this@GameActivity,backCrystals[i], frontCrystals[i])
                delay(100)
            }
            ...
            for (i in 0..34 ){
                flipKartunka(this@GameActivity,frontCrystals[i], backCrystals[i])
                delay(50)
            }
            delay(500)
